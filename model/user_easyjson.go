...
func easyjson9e1087fdDecodeAppConstructorBackendModel5(in *jlexer.Lexer, out *ClientJwt) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9e1087fdEncodeAppConstructorBackendModel5(out *jwriter.Writer, in ClientJwt) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
// MarshalJSON supports json.Marshaler interface
func (v ClientJwt) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9e1087fdEncodeAppConstructorBackendModel5(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}

// MarshalEasyJSON supports easyjson.Marshaler interface
func (v ClientJwt) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson9e1087fdEncodeAppConstructorBackendModel5(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *ClientJwt) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson9e1087fdDecodeAppConstructorBackendModel5(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ClientJwt) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9e1087fdDecodeAppConstructorBackendModel5(l, v)
}
func easyjson9e1087fdDecodeAppConstructorBackendModel6(in *jlexer.Lexer, out *ClientClaims) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9e1087fdEncodeAppConstructorBackendModel6(out *jwriter.Writer, in ClientClaims) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Audience != "" {
...
// MarshalJSON supports json.Marshaler interface
func (v ClientClaims) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9e1087fdEncodeAppConstructorBackendModel6(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}

// MarshalEasyJSON supports easyjson.Marshaler interface
func (v ClientClaims) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson9e1087fdEncodeAppConstructorBackendModel6(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *ClientClaims) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson9e1087fdDecodeAppConstructorBackendModel6(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ClientClaims) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9e1087fdDecodeAppConstructorBackendModel6(l, v)
}
